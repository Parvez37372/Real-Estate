                ...
                <div class="container3">
                    <div class="flat-img-with-text-v2">
                        <div class="content-left tf-image-box">
                            <div class="grid-img-group abt">
                                <div class="tf-image-wrap item-1">
                                    <div class="img-style hover-img-wrap">
                                        <img class="lazyload" data-src="images/banner/img-w-text-sm1.jpg" src="images/banner/img-w-text-sm1.jpg" alt="">
                                    </div>
                                ...
                                <div class="tf-image-wrap item-2">
                                    <div class="img-style hover-img-wrap">
                                        <img class="lazyload" data-src="images/banner/img-w-text2.jpg" src="images/banner/img-w-text2.jpg" alt="">
                                    </div>
                                ...
                                <div class="tf-image-wrap item-3">
                                    <div class="img-style hover-img-wrap">
                                        <img class="lazyload" data-src="images/banner/img-w-text-sm2.jpg" src="images/banner/img-w-text-sm2.jpg" alt="">
                                    </div>
                        ...
                        <div class="content-right">
                            <div class="box-title wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration="2000ms">
                                <div class="text-subtitle text-primary">About Us</div>
                                <h3 class="title mt-4">Discover what sets our Real Estate expertise apart</h3>
                                <p class="desc text-variant-1">Welcome to Mahi Realty, your trusted partner in the world of real estate. As a leading builder and property seller, we specialize in offering a wide range of residential, commercial, properties to meet the diverse needs of our clients. Whether you're looking for your dream home, an investment opportunity, or a commercial space to grow your business, we are here to make your journey smooth and successful.<br><br>

At Mahi Realty, we understand that purchasing or selling property is a significant decision. That's why we are committed to providing a seamless, transparent, and professional experience. With years of expertise in the real estate industry, our team is dedicated to offering properties that meet the highest standards of quality, design, and value.<br><br>

Our values are rooted in trust, integrity, and customer satisfaction. We believe in building long-term relationships with our clients, understanding their needs, and offering personalized solutions that align with their goals. Every property we deal with is handpicked to ensure it meets our strict criteria for quality and investment potential.<br><br>

Mahi Realty is more than just a property seller. We are a team of passionate professionals who are committed to delivering not only the best properties but also exceptional customer service. Our goal is to be your first choice for all your real estate needs, offering guidance, support, and expertise every step of the way.
                                </p>
                            </div>
                            <div class="flat-service">
                                <a href="#" class="box-benefit hover-btn-view">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="description">At Mahi Realty, our mission is to make real estate simple, transparent, and rewarding. We are committed to helping individuals and families find the perfect property through personalized guidance, expert knowledge, and honest service. Whether buying, selling, or investing, we strive to deliver a smooth experience with reliable support every step of the way. By combining local expertise with modern tools, we connect clients with homes and investments that suit their lifestyle and goals. At Mahi Realty, we don’t just deal in properties—we build trust, relationships, and dreams.
                                        </p>
                                ...
                                <a href="#" class="box-benefit hover-btn-view">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="description">Our vision at Mahi Realty is to become a trusted leader in the real estate industry by setting new standards in service, innovation, and client satisfaction. We aspire to create a platform where property transactions are smooth, informed, and empowering for everyone. We envision communities where every individual has access to quality homes and investment opportunities that align with their dreams. Through continuous growth, technology adoption, and a client-first approach, we aim to shape a future where Mahi Realty is synonymous with integrity, excellence, and lasting impact in real estate.
                                        </p>
                                        <!-- <span class="btn-view style-1"><span class="text">Explore Now</span> <span class="icon icon-arrow-right2"></span> </span> -->
