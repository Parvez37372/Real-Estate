...
<section class="pt-5 flat-recommended">
    <div class="container">
        <div class="box-title text-center wow fadeInUp">
            <h3 class="mt-4 title">My Wishlist</h3>
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="allData">
                    <div class="row">
                        ...
                        $wish = mysqli_query($conn,"select * from wishlist where user_id='$u_id'");
                        while($rowss = mysqli_fetch_assoc($wish)){
                        $allProps = mysqli_query($conn, "SELECT * FROM property WHERE id='{$rowss['property_id']}' and status = 1 ORDER BY created_at DESC");
